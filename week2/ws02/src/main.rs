...
// fn main() {
//     // vec
//     // let mut v = Vec::new(); // creating new empty vec
//     // v.push(2);
//     // v.push(2);
//     // v.push(2);
//     // v.push(2);
...
//     // let v = Vec::from([2, 2, 2, 2, 2]);
//     // // println!("{:?}", v);
//     // let v = vec![2, 2, 2, 2, 2];
//     // // println!("{:?}", v);

//     // let v2 = Vec::from_iter(v.iter());
//     // // println!("{:?}", v2);

//     // hashmap
//     let mut hm = HashMap::from([(String::from("Tom"), 85), (String::from("Shrey"), 99)]);
//     // println!("{:?}",hm);
//     // hm.insert(String::from("Tom"), 65);
//     // println!("{:?}",hm.get(&"Tomo".to_string()).expect("Key doesn't exist")); // implictly type cast
//     // hm.get("Tom");
//     // match hm.get(&"Tomo".to_string()) {
//     //     Some(value) => println!("{:?}",value),
//     //     None => println!("{:?}", 0)
//     // }

//     // if let Some(value) = hm.get(&"Tomo".to_string()) {
//     //     println!("{:?}",value);
//     // } else {
//     //     println!("{:?}", 0);
//     // }
...
//     // String: owned string, stored on heap, dynamically change size
//     // &str: string slice, readable only
    
//     // macro: Copy, Clone, Debug 属性
//     // Copy
//     // #[derive(Copy, Clone)]
//     // i32
//     // let i = 42;
//     // let i2 = i; // Copy operation, bit by bit copy
//     // println!("{}", i2);

//     // let s1 = String::from("Tom");
//     // let s2 = s1.clone(); // Move operation
//     // println!("{}", s1);
    

//     // let s = String::from("Hello");
//     // let s2 = s; // Move operation
//     // Clone
//     // let s2 = s.clone(); // Clone operation
//     // println!("{}", s2);
//     // println!("{}", s);
...
//     // If String can use Copy, what will happen?
//     // Both string will have a pointer pointing towards 
//     // the same address, which could results double fre
//     // issue
